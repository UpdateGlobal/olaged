...
<head>
	...
	<title>Nuestro Blog - Olaged</title>
...
<div id="pi-all">
	<?php $menu="blog"; include("include/navegacion.php") ?>
</div>
<!-- End header -->
...
El Poder Policía constituye una de las manifestaciones de la Función Administrativa del Estado. Esta consiste en la ordenación, regulación, limitación de derechos, para articularlos, coordinarlos, adecuarlos al interés general, público o derechos o intereses legítimos de otros ciudadanos. A estas función también se le conoce como "Regulación Administrativa"
						...
						<p>
							<a href="nota-blog.php" class="btn pi-btn-base">
								Leer mas
							</a>
						</p>
					</div>
				...
				<div class="pi-row">
					...
					<div class="pi-col-sm-10">
						<h2 class="h3 pi-margin-top-minus-5">
							<a href="nota-blog2.php" class="pi-link-dark">Los problemas del Servicio Civil. Persistencia de problemas y de falta de medidas (parte 2)</a>
						</h2>
						...
						<p>
							<a href="nota-blog2.php" class="btn pi-btn-base">
								Leer mas
							</a>
						</p>
					</div>
				...
				<div class="pi-row">
					...
					<div class="pi-col-sm-10">
						<h2 class="h3 pi-margin-top-minus-5">
							<a href="nota-blog3.php" class="pi-link-dark">Los principios del procedimiento administrativo sancionador. Razones para una discrepancia.</a>
						</h2>
						<p>
...
Si bien ambas ramas se manifiestan en actividades sancionadoras del Estado, discrepo en la aplicación automática de los principios y garantías penales. Esto, porque existen diferencias que justifican su trato diferente y no son automáticamente equiparables.
						...
						<p>
							<a href="nota-blog3.php" class="btn pi-btn-base">
								Leer mas
							</a>
						</p>
					</div>
