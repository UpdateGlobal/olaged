...
<head>
	...
	<title>Los problemas del Servicio Civil. Persistencia de problemas y de falta de medidas (parte 2)</title>
	...
	<div class="pi-section" style="padding: 30px 40px 26px;">
		...
		<div class="pi-row">
			...
			<div class="pi-col-sm-8 pi-text-right pi-center-text-xs">
				<p class="lead-20 pi-weight-300 pi-margin-top-5 pi-margin-bottom-5">Los problemas del Servicio Civil. Persistencia de problemas y de falta de medidas (parte 2)</p>
			</div>
		</div>
