...
<head>
	...
	<!--Fonts-->
	<link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,100,300,600,700,800&amp;subset=latin,cyrillic'
...
<div class="tp-caption sft str sube"
	 ...
	 data-endspeed="300"
	 style="z-index: 4; font-size: 28px; color: #21252b; font-weight: 600; letter-spacing: 0px; text-transform: uppercase; line-height: 40px; background: rgba(255, 255, 255, 0.9); padding: 0px 16px; border-radius: 10px; box-shadow: 0 1px 1px rgba(0,0,0,0.15); height: 200px; width: 800px;">
	 <div class="achi">
	     <p>Curso especializado </p></div>
	       <p>En Contratación Publica <span style="font-size: 21px;">modalidad presencial</span></p>
	     <p><span style="font-size: 21px; color: #27bdfd;">clases sábados: 11,18, 25 de noviembre del 2017 de 9 a.m a 1 p.m.</span></p>
</div>
