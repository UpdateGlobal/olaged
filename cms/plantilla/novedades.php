...
<body>
    ...
    <div class="container">
	    <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Nuestras Novedades</h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Inicio</a></li>
                    <li class="active"><strong>Novedades</strong></li>
                </ol>
            </div>
		</div>
        <div class="row">
            <div class="col-lg-12">
				<?php 
                    ...
                    $filab=mysqli_fetch_array($ejecutarBanner);
                        ...
                        $xnombre = substr(utf8_decode($filab['nom_producto']),0,20);
                ?>
    ...
    <div class="container">
		<div class="row">	
            <div class="col-lg-12">
                <h2 class="page-header">Cat&aacute;logo : Novedades</h2>
            </div>
        </div>
		<div class="row">
			<div class="col-md-12">
				<section class="regular slider">
                    <?php 
						$productos="SELECT * FROM productos WHERE estado='Activo' AND novedad='si' ORDER BY RAND() DESC LIMIT 0,10";
