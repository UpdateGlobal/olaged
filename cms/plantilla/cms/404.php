...
<head>
	...
	<title>Raúl Administrador ! 404 Error</title>
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo $xIco ?>" />
	<link rel="apple-touch-icon" sizes="114x114" href="<?php echo $xIco ?>" />
	<link rel="apple-touch-icon" sizes="72x72" href="<?php echo $xIco ?>" />
	<link rel="apple-touch-icon" sizes="57x57" href="<?php echo $xIco ?>" />
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo $xIco ?>" />
...
<body>
	...
	<div id="wrapper">
		...
		<div class="footer footerror">
			<h1>Error 404</h1>
			<a href="index.php" class="icon-button icon-medium"><i class="fa fa-bug"></i> Error 404</a>
		</div>
	</div>
