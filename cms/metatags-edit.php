...
if($proceso == "Actualizar"){
  ...
  $ActualizarMeta = "UPDATE metatags SET cod_meta='$cod_meta', titulo='$titulo', slogan='$slogan', logo='$logo', description='$description', keywords='$keywords', url='$url', face1='$face1', face2='$face2', ico='$ico' WHERE cod_meta='$cod_meta'";
        ...
        <div class="card">
          ...
          <form class="fcms" name="fcms" method="post" action="" data-provide="validation" data-disable="false">
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label class="col-form-label require" for="titulo">Título de la web</label>
                </div>
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  ...
                  <small>(Sepárelas con una coma)</small>
                </div>
                <div class="col-8 col-lg-10">
                  <?php if($xVisitante=="1"){ ?><p><?php echo $xKey; ?></p><?php } ?>
                  <input class="form-control" id="key" name="keywords" type="<?php if($xVisitante=="1"){ ?>hidden<?php }else{ ?>text<?php } ?>" value="<?php echo $xKey; ?>">
                  <div class="invalid-feedback"></div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-4 col-lg-2">
                  <label for="social">Imágenes para redes sociales:</label><br>
            ...
            <footer class="card-footer">
              ...
              <button class="btn btn-bold btn-primary" type="button" name="boton" onClick="javascript:Validar();" /><i class="fa fa-refresh"></i> Editar Metatags</button>
